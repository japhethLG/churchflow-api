...
export class CampaignItemProgressDto {
  ...
  @Expose()
  @ApiProperty({ example: AMOUNT_EXAMPLE, description: 'Sum of pledges against this item' })
  pledgedAmount!: number;

  @Expose()
  @ApiProperty({ example: AMOUNT_EXAMPLE, description: 'Sum of transactions attributed to this item' })
  raisedAmount!: number;
...
export class CampaignProgressResponseDto {
  ...
  @Expose()
  @ApiProperty({ example: AMOUNT_EXAMPLE, description: 'Goal = sum of items.targetAmount' })
  goalAmount!: number;

  @Expose()
  @ApiProperty({ example: AMOUNT_EXAMPLE, description: 'Sum of pledges (items + unscoped campaign pledges)' })
  pledgedAmount!: number;

  @Expose()
  @ApiProperty({ example: AMOUNT_EXAMPLE, description: 'Sum of transactions attributed to this campaign' })
  raisedAmount!: number;
