...
export class TransactionRepository {
  ...
  async findById(tenantId: string, id: string): Promise<Transaction | null> {
    return this.prisma.transaction.findFirst({ where: { id, tenantId, deletedAt: null } });
  }

  async findAll(tenantId: string, filters: TransactionFilters): Promise<TransactionListResult> {
  ...
  async update(_tenantId: string, id: string, data: UpdateTransactionInput): Promise<Transaction> {
